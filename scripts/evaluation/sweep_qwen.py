"""SLURM launcher: Qwen2.5-7B baseline vs recover_pos_enc, 4 benchmarks, 1000
...
capped at MAX_EXAMPLES=1000 (set inside run_eval_qwen.sh) -> result/qwen_sweep/.
...
SCRIPT_PATH = f"{PROJECT_DIR}/scripts/evaluation/run_eval_qwen.sh"
OUT_SUBDIR = "qwen_sweep"
...
def run_slurm(only="", dry_run=False, force=False):
    ...
    launch_tasks(
        ...
        job_name="qwen_sweep", max_job_num=80,
