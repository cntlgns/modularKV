"""SLURM launcher: Qwen3-8B (non-thinking) baseline vs recover_pos_enc, 4 benchmarks, 1000
...
capped at MAX_EXAMPLES=1000 (set inside run_eval_qwen3.sh) -> result/qwen_sweep/.
...
SCRIPT_PATH = f"{PROJECT_DIR}/scripts/evaluation/run_eval_qwen3.sh"
OUT_SUBDIR = "qwen3_sweep"
...
def run_slurm(only="", dry_run=False, force=False):
    ...
    launch_tasks(
        ...
        partition="rtx3090", exclude="radish", qos="normal", timeout="1-0",
        job_name="qwen3_sweep", max_job_num=80,
